...
const InvoiceCard: React.FC<InvoiceCardProps> = ({ itemsShow }) => {
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
                    ...
                    <div>
                      ...
                      <span className="mt-2 block">
                        ...
                        {itemsShow?.customerInfo.phoneNumber}
                      </span>
                    </div>
                  </div>
                ...
                <div className="mx-4 flex flex-wrap">
                  <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
                    <div className="mb-10">
                      ...
                      <p className="font-medium">
                        {itemsShow?.deliveryInfo.deliveryType}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
                    <div className="mb-10">
                      ...
                      <p className="font-medium">
                        {itemsShow?.paymentInfo.paymentType}
                      </p>
                    </div>
                  </div>
