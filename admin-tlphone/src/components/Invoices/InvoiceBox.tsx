                        ...
                        <div ref={contentToPrint} className="p-4 sm:p-6 xl:p-9">
                            <div className="flex flex-col-reverse gap-5 xl:flex-row xl:justify-between">
                                <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
                                    <div>
                                        ...
                                        <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white">GLAMIFY</h4>
                                        <a className="block" href="#">
                                            <span className="font-medium">Email: </span>
                                            blackcatstudio2024@gmail.com
                                        </a>
                                    ...
                                    <div>
                                        ...
                                        <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white">{itemsShow?.personalDetails.lastName}</h4>
                                        <a className="block" href="#">
                                            <span className="font-medium">Email: </span>
                                            {itemsShow?.personalDetails.email}
                                        </a>
                                        <span className="mt-2 block">
                                            <span className="font-medium">Address: </span>
                                            {itemsShow?.deliveryInfo.address}
                                        </span>
                                        <span className="mt-2 block">
                                            <span className="font-medium">Phone number: </span>
                                            {itemsShow?.personalDetails.phoneNumber}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="my-7.5 grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-3">
                                <div className="border-b border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark sm:border-b-0 sm:border-r">
                                    ...
                                    <span className="text-sm font-medium">
                                        {new Date(itemsShow?.createdAt ?? "").toDateString()}
                                    </span>
                                </div>
                                ...
                                <div className="border-b border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark xsm:border-b-0">
                                    ...
                                    <span className="text-sm font-medium">
                                        {new Date(new Date(itemsShow?.createdAt ?? "").setDate(new Date(itemsShow?.createdAt ?? "").getDate() + 7)).toDateString()}
                                    </span>
                                </div>
                            ...
                            <div className="my-10 gap-1 rounded-sm border border-stroke p-5 dark:border-strokedark">
                                {itemsShow?.listProducts.map((product, index) => (
                                    <div key={product.productId} className="items-center sm:flex gap-0">
                                        ...
                                        <div className="w-full items-center justify-between md:flex">
                                            <div className="mb-3 md:mb-0">
                                                <a className="inline-block font-medium text-black hover:text-primary dark:text-white" href="#">
                                    ...
                                    <div className="mr-10 text-right md:ml-auto">
                                        <div className="ml-auto sm:w-3/4">
                                            <p className="mb-4 flex justify-between font-medium text-black dark:text-white">
                                                <span> Subtotal </span>
                                                <span> {itemsShow?.totalAmount} </span>
                                            </p>
                                            <p className="mb-4 flex justify-between font-medium text-black dark:text-white">
                                                <span> Shipping Cost (+) </span>
                                                <span>  {itemsShow?.deliveryType == "STANDARD" ? 25000 : itemsShow?.deliveryType == "FAST" && 50000}đ </span>
                                            </p>
                                            <p className="mb-4 flex justify-between font-medium text-black dark:text-white">
                                                <span>
                                                    Vat
                                                ...
                                                <span> {(itemsShow?.totalAmount ?? 0) * 0.1}đ </span>
                                            </p>
                                            <p className="mb-4 mt-2 flex justify-between border-t border-stroke pt-6 font-medium text-black dark:border-strokedark dark:text-white">
                                                ...
                                                <span> {itemsShow?.totalAmount && (itemsShow?.totalAmount * 1.1 + (itemsShow?.deliveryType == "STANDARD" ? 25000 : itemsShow?.deliveryType == "FAST" ? 50000 : 0)).toFixed(3)}đ </span>
                                            </p>
                                        </div>
