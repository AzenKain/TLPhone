...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let dataUser: UserType = await makeRequestApi(
        getUserByIdApi,
        session?.userId,
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        >
          <h4 className="text-center text-title-xxl font-medium leading-[30px] text-white">
            Admin
          </h4>
          <Image
            src={"/logo/TLPhone.png"}
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {(dataUser?.role?.includes("ADMIN") ||
                dataUser?.role?.includes("WEREHOUSEMANGER")) && (
                <li>
                  <Link
