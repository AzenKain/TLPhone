                  ...
                  <div id="changePasswordForm" className="space-y-6">
                      ...
                      <div className="flex justify-between">
                          <button
                            ...
                            className="px-4 py-2 rounded-lg border-2 text-sm font-medium text-gray-500 bg-gray-200 rounded-md hover:bg-gray-300 focus:outline-none focus:ring focus:border-blue-300"
                          >
                              Discard
                          </button>
                          <button
